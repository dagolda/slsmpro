...
use Bo\AdminBundle\Entity\Entreprise;
use Bo\AdminBundle\Form\EntrepriseType;
...
class EntrepriseController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entreprises = $em->getRepository('BoAdminBundle:Entreprise')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Bo\AdminBundle\Form\EntrepriseType', $entreprise);
    ...
    {
        $deleteForm = $this->createDeleteForm($entreprise);
        $editForm = $this->createForm('Bo\AdminBundle\Form\EntrepriseType', $entreprise);
