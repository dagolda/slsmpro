...
class RevisionType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('hour',null,array('required'=>true,'attr'=>array('size'=>30)))
	    ...
	    ->add('hourafter',null,array('attr'=>array('size'=>30)))
            ->add('total',null,array('required'=>true,'attr'=>array('size'=>30)))
            ->add('total1',null,array('required'=>false,'attr'=>array('size'=>30)))
