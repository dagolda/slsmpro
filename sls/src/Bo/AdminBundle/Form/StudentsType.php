...
class StudentsType extends AbstractType
{
    ...
    {
        $builder
            ->add('name',null,array('attr'=>array('size'=>40)))
            ->add('firstname',null,array('attr'=>array('size'=>40)))
            ->add('startlevel',null,array('required'=>false,'attr'=>array('size'=>40)))
            ...
            ->add('email',EmailType::class,array('required'=>false,'attr'=>array('size'=>40)))
            ->add('phonenumber1',null,array('required'=>false,'attr'=>array('size'=>40)))
            ->add('email1',EmailType::class,array('required'=>false,'attr'=>array('size'=>40)))			
        ;
    }
