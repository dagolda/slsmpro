...
class EmployeeType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('address1',TextareaType::class,array('required'=>false,'attr'=>array('cols'=>66,'rows'=>2)))
            ->add('address2',TextareaType::class,array('required'=>false,'attr'=>array('cols'=>66,'rows'=>2)))
