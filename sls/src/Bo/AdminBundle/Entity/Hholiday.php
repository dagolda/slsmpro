...
* Nom fichier : Hholiday.php
* Description: Entité Hour of admin (timesheet)
*/
...
/**
* @ORM\Entity
* @ORM\Table(name="adm_hholiday")
* @ORM\Entity(repositoryClass="Bo\AdminBundle\Repository\HholidayRepository")
*/
class Hholiday 
{
    /**
