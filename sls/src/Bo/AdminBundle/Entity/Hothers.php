...
* Nom fichier : Hothers.php
* Description: Hour of timesheet others
*/
...
/**
* @ORM\Entity
* @ORM\Table(name="adm_hothers")
* @ORM\Entity(repositoryClass="Bo\AdminBundle\Repository\HothersRepository")
*/
class Hothers 
{
    /**
