...
class Employee
{
    ...
    */
     ...
     * Set loginsentby
     *
     * @param string $loginsentby
     *
     * @return Employee
     */
    public function setLoginsentby($loginsentby)
    {
        $this->loginsentby = $loginsentby;
    ...
    {
        return $this->loginsentby;
    }

    /**
     * Set loginsentdate
     *
     * @param \DateTime $loginsentdate
     *
     * @return Employee
     */
    public function setLoginsentdate($loginsentdate)
    {
        $this->loginsentdate = $loginsentdate;
