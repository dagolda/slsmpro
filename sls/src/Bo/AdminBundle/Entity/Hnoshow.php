...
* Nom fichier : Hnoshow.php
* Description: Hour of timesheet No show
*/
...
/**
* @ORM\Entity
* @ORM\Table(name="adm_hnoshow")
* @ORM\Entity(repositoryClass="Bo\AdminBundle\Repository\HnoshowRepository")
*/
class Hnoshow 
{
    /**
