 ...
 */
class Rubric extends \Bo\AdminBundle\Entity\Rubric implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Bo\\AdminBundle\\Entity\\Rubric' . "\0" . 'id', '' . "\0" . 'Bo\\AdminBundle\\Entity\\Rubric' . "\0" . 'namefr', '' . "\0" . 'Bo\\AdminBundle\\Entity\\Rubric' . "\0" . 'nameen'];
        }
