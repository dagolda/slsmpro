 ...
 */
class Contractual extends \Bo\AdminBundle\Entity\Contractual implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Bo\\AdminBundle\\Entity\\Contractual' . "\0" . 'id', '' . "\0" . 'Bo\\AdminBundle\\Entity\\Contractual' . "\0" . 'name', '' . "\0" . 'Bo\\AdminBundle\\Entity\\Contractual' . "\0" . 'email', '' . "\0" . 'Bo\\AdminBundle\\Entity\\Contractual' . "\0" . 'phone', '' . "\0" . 'Bo\\AdminBundle\\Entity\\Contractual' . "\0" . 'createby', '' . "\0" . 'Bo\\AdminBundle\\Entity\\Contractual' . "\0" . 'typecontract', '' . "\0" . 'Bo\\AdminBundle\\Entity\\Contractual' . "\0" . 'creationdate'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Contractual $proxy) {
