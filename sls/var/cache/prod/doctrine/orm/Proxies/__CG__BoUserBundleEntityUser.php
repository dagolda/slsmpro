...
namespace Proxies\__CG__\Bo\UserBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \Bo\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'Bo\\UserBundle\\Entity\\User' . "\0" . 'employee', '' . "\0" . 'Bo\\UserBundle\\Entity\\User' . "\0" . 'students', '' . "\0" . 'Bo\\UserBundle\\Entity\\User' . "\0" . 'idcoordinator', 'pwd', '' . "\0" . 'Bo\\UserBundle\\Entity\\User' . "\0" . 'role', '' . "\0" . 'Bo\\UserBundle\\Entity\\User' . "\0" . 'creationdate', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt'];
        }
    ...
    public function setIdcoordinator($idcoordinator)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdcoordinator', [$idcoordinator]);

        return parent::setIdcoordinator($idcoordinator);
    }
    ...
    public function getIdcoordinator()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdcoordinator', []);

        return parent::getIdcoordinator();
    }
