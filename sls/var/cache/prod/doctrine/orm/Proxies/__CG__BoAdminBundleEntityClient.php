 ...
 */
class Client extends \Bo\AdminBundle\Entity\Client implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Bo\\AdminBundle\\Entity\\Client' . "\0" . 'id', '' . "\0" . 'Bo\\AdminBundle\\Entity\\Client' . "\0" . 'reference', '' . "\0" . 'Bo\\AdminBundle\\Entity\\Client' . "\0" . 'typecontract', '' . "\0" . 'Bo\\AdminBundle\\Entity\\Client' . "\0" . 'designation', '' . "\0" . 'Bo\\AdminBundle\\Entity\\Client' . "\0" . 'phonenumber', '' . "\0" . 'Bo\\AdminBundle\\Entity\\Client' . "\0" . 'address', '' . "\0" . 'Bo\\AdminBundle\\Entity\\Client' . "\0" . 'billingaddress', '' . "\0" . 'Bo\\AdminBundle\\Entity\\Client' . "\0" . 'email', '' . "\0" . 'Bo\\AdminBundle\\Entity\\Client' . "\0" . 'createby', '' . "\0" . 'Bo\\AdminBundle\\Entity\\Client' . "\0" . 'details'];
        }
