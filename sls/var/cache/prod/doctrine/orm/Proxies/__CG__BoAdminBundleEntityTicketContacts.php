 ...
 */
class TicketContacts extends \Bo\AdminBundle\Entity\TicketContacts implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = ['name' => NULL, 'cc' => NULL];
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Bo\\AdminBundle\\Entity\\TicketContacts' . "\0" . 'id', 'name', '' . "\0" . 'Bo\\AdminBundle\\Entity\\TicketContacts' . "\0" . 'employee', 'cc', '' . "\0" . 'Bo\\AdminBundle\\Entity\\TicketContacts' . "\0" . 'creationdate', '' . "\0" . 'Bo\\AdminBundle\\Entity\\TicketContacts' . "\0" . 'createby'];
        }

        return ['__isInitialized__', '' . "\0" . 'Bo\\AdminBundle\\Entity\\TicketContacts' . "\0" . 'id', '' . "\0" . 'Bo\\AdminBundle\\Entity\\TicketContacts' . "\0" . 'employee', '' . "\0" . 'Bo\\AdminBundle\\Entity\\TicketContacts' . "\0" . 'creationdate', '' . "\0" . 'Bo\\AdminBundle\\Entity\\TicketContacts' . "\0" . 'createby'];
    }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TicketContacts $proxy) {
