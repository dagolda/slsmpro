 ...
 */
class Campus extends \Bo\AdminBundle\Entity\Campus implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Bo\\AdminBundle\\Entity\\Campus' . "\0" . 'id', '' . "\0" . 'Bo\\AdminBundle\\Entity\\Campus' . "\0" . 'reference', '' . "\0" . 'Bo\\AdminBundle\\Entity\\Campus' . "\0" . 'designation', '' . "\0" . 'Bo\\AdminBundle\\Entity\\Campus' . "\0" . 'address', '' . "\0" . 'Bo\\AdminBundle\\Entity\\Campus' . "\0" . 'city', '' . "\0" . 'Bo\\AdminBundle\\Entity\\Campus' . "\0" . 'province', '' . "\0" . 'Bo\\AdminBundle\\Entity\\Campus' . "\0" . 'createby', '' . "\0" . 'Bo\\AdminBundle\\Entity\\Campus' . "\0" . 'creationdate'];
        }
