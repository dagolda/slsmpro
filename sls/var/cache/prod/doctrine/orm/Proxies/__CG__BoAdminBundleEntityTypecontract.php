 ...
 */
class Typecontract extends \Bo\AdminBundle\Entity\Typecontract implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Bo\\AdminBundle\\Entity\\Typecontract' . "\0" . 'id', '' . "\0" . 'Bo\\AdminBundle\\Entity\\Typecontract' . "\0" . 'reference', '' . "\0" . 'Bo\\AdminBundle\\Entity\\Typecontract' . "\0" . 'designation', '' . "\0" . 'Bo\\AdminBundle\\Entity\\Typecontract' . "\0" . 'apd', '' . "\0" . 'Bo\\AdminBundle\\Entity\\Typecontract' . "\0" . 'creationdate', '' . "\0" . 'Bo\\AdminBundle\\Entity\\Typecontract' . "\0" . 'details'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Typecontract $proxy) {
    ...
    public function setApd($apd)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setApd', [$apd]);

        return parent::setApd($apd);
    }
    ...
    public function getApd()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getApd', []);

        return parent::getApd();
    }
