...
/* BoAdminBundle:Advisors:pagination.html.twig */
class __TwigTemplate_b812f8e9fd37de31227b91a6b15608a10724217184476d50d83b481db7b2c1b0 extends Twig_Template
{
    ...
    {
        $__internal_88f2086bc610aa1e538326ae1f5f40ec162810e2907222c116c5c6caf54ef3bf = $this->env->getExtension("native_profiler");
        $__internal_88f2086bc610aa1e538326ae1f5f40ec162810e2907222c116c5c6caf54ef3bf->enter($__internal_88f2086bc610aa1e538326ae1f5f40ec162810e2907222c116c5c6caf54ef3bf_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "BoAdminBundle:Advisors:pagination.html.twig"));
...
\t\t\t\t<a href=\"";
        // line 4
        echo $this->env->getExtension('routing')->getPath("advisors_page", array("option" => 1));
        echo "\" title=\"";
...
\t\t\t\t<a href=\"";
        // line 9
        echo $this->env->getExtension('routing')->getPath("advisors_page", array("option" => 2));
        echo "\" title=\"";
...
\t\t\t\t<a href=\"";
        // line 16
        echo $this->env->getExtension('routing')->getPath("advisors_page", array("option" => 3));
        echo "\" title=\"";
...
\t\t\t\t<a href=\"";
        // line 21
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("advisors_page", array("option" => (isset($context["nb_pages"]) ? $context["nb_pages"] : $this->getContext($context, "nb_pages")))), "html", null, true);
        echo "\" title=\"";
...
\t\t</ul>";
        ...
        $__internal_88f2086bc610aa1e538326ae1f5f40ec162810e2907222c116c5c6caf54ef3bf->leave($__internal_88f2086bc610aa1e538326ae1f5f40ec162810e2907222c116c5c6caf54ef3bf_prof);

    }

    public function getTemplateName()
    {
        return "BoAdminBundle:Advisors:pagination.html.twig";
    }
...
/* 			<li class="sty-label">Page:</li>*/
/* 			<li class="page_first">*/
/* 				<a href="{{ path('advisors_page', {'option': 1}) }}" title="{{'label.firstpage'|trans([],'BoAdminBundle')}}">*/
/* 					<img src="{{ asset('images/actions/first.gif') }}"/>*/
/* 				</a>*/
/* 			</li>*/
/* 			<li>*/
/* 				<a href="{{ path('advisors_page', {'option': 2}) }}" title="{{'label.previouspage'|trans([],'BoAdminBundle')}}">*/
...
/* 			</li>*/
/* 			<li>*/
/* 				<a href="{{ path('advisors_page', {'option': 3}) }}" title="{{'label.nextpage'|trans([],'BoAdminBundle')}}">*/
/* 					<img src="{{ asset('images/actions/next.gif') }}"/>*/
/* 				</a>*/
/* 			</li>*/
/* 			<li>*/
/* 				<a href="{{ path('advisors_page', {'option': nb_pages}) }}" title="{{'label.lastpage'|trans([],'BoAdminBundle')}}">*/
