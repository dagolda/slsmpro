...
/* BoAdminBundle:Securitycote:pagination.html.twig */
class __TwigTemplate_a95c3424355e6b4cf176b234e8bb5bbdbc257503ea6aa417f52d04bff83f532a extends Twig_Template
{
    ...
    {
        $__internal_d962471442dbf5b7d1c56f64280a4caa69f60c83778571f82cf7392b7b4daf16 = $this->env->getExtension("native_profiler");
        $__internal_d962471442dbf5b7d1c56f64280a4caa69f60c83778571f82cf7392b7b4daf16->enter($__internal_d962471442dbf5b7d1c56f64280a4caa69f60c83778571f82cf7392b7b4daf16_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "BoAdminBundle:Securitycote:pagination.html.twig"));
...
\t\t\t\t<a href=\"";
        // line 4
        echo $this->env->getExtension('routing')->getPath("securitycote_page", array("option" => 1));
        echo "\" title=\"";
...
\t\t\t\t<a href=\"";
        // line 9
        echo $this->env->getExtension('routing')->getPath("securitycote_page", array("option" => 2));
        echo "\" title=\"";
...
\t\t\t\t<a href=\"";
        // line 16
        echo $this->env->getExtension('routing')->getPath("securitycote_page", array("option" => 3));
        echo "\" title=\"";
...
\t\t\t\t<a href=\"";
        // line 21
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("securitycote_page", array("option" => (isset($context["nb_pages"]) ? $context["nb_pages"] : $this->getContext($context, "nb_pages")))), "html", null, true);
        echo "\" title=\"";
...
\t\t</ul>";
        ...
        $__internal_d962471442dbf5b7d1c56f64280a4caa69f60c83778571f82cf7392b7b4daf16->leave($__internal_d962471442dbf5b7d1c56f64280a4caa69f60c83778571f82cf7392b7b4daf16_prof);

    }

    public function getTemplateName()
    {
        return "BoAdminBundle:Securitycote:pagination.html.twig";
    }
...
/* 			<li class="sty-label">Page:</li>*/
/* 			<li class="page_first">*/
/* 				<a href="{{ path('securitycote_page', {'option': 1}) }}" title="{{'label.firstpage'|trans([],'BoAdminBundle')}}">*/
/* 					<img src="{{ asset('images/actions/first.gif') }}"/>*/
/* 				</a>*/
/* 			</li>*/
/* 			<li>*/
/* 				<a href="{{ path('securitycote_page', {'option': 2}) }}" title="{{'label.previouspage'|trans([],'BoAdminBundle')}}">*/
...
/* 			</li>*/
/* 			<li>*/
/* 				<a href="{{ path('securitycote_page', {'option': 3}) }}" title="{{'label.nextpage'|trans([],'BoAdminBundle')}}">*/
/* 					<img src="{{ asset('images/actions/next.gif') }}"/>*/
/* 				</a>*/
/* 			</li>*/
/* 			<li>*/
/* 				<a href="{{ path('securitycote_page', {'option': nb_pages}) }}" title="{{'label.lastpage'|trans([],'BoAdminBundle')}}">*/
