...
/* BoAdminBundle:Message:pagination.html.twig */
class __TwigTemplate_066dd343983078ff26e5b8800f2943300272101e4db333b405819b6060d0194c extends Twig_Template
{
    ...
    {
        $__internal_5b362ac74b9b18d8d20d05725091cdd22fb63251375bf9bffc1b106dc9d26ed1 = $this->env->getExtension("native_profiler");
        $__internal_5b362ac74b9b18d8d20d05725091cdd22fb63251375bf9bffc1b106dc9d26ed1->enter($__internal_5b362ac74b9b18d8d20d05725091cdd22fb63251375bf9bffc1b106dc9d26ed1_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "BoAdminBundle:Message:pagination.html.twig"));
...
\t\t\t\t<a href=\"";
        // line 4
        echo $this->env->getExtension('routing')->getPath("message_page", array("option" => 1));
        echo "\" title=\"";
...
\t\t\t\t<a href=\"";
        // line 9
        echo $this->env->getExtension('routing')->getPath("message_page", array("option" => 2));
        echo "\" title=\"";
...
\t\t\t\t<a href=\"";
        // line 16
        echo $this->env->getExtension('routing')->getPath("message_page", array("option" => 3));
        echo "\" title=\"";
...
\t\t\t\t<a href=\"";
        // line 21
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("message_page", array("option" => (isset($context["nb_pages"]) ? $context["nb_pages"] : $this->getContext($context, "nb_pages")))), "html", null, true);
        echo "\" title=\"";
...
\t\t</ul>";
        ...
        $__internal_5b362ac74b9b18d8d20d05725091cdd22fb63251375bf9bffc1b106dc9d26ed1->leave($__internal_5b362ac74b9b18d8d20d05725091cdd22fb63251375bf9bffc1b106dc9d26ed1_prof);

    }

    public function getTemplateName()
    {
        return "BoAdminBundle:Message:pagination.html.twig";
    }
...
/* 			<li class="sty-label">Page:</li>*/
/* 			<li class="page_first">*/
/* 				<a href="{{ path('message_page', {'option': 1}) }}" title="{{'label.firstpage'|trans([],'BoAdminBundle')}}">*/
/* 					<img src="{{ asset('images/actions/first.gif') }}"/>*/
/* 				</a>*/
/* 			</li>*/
/* 			<li>*/
/* 				<a href="{{ path('message_page', {'option': 2}) }}" title="{{'label.previouspage'|trans([],'BoAdminBundle')}}">*/
...
/* 			</li>*/
/* 			<li>*/
/* 				<a href="{{ path('message_page', {'option': 3}) }}" title="{{'label.nextpage'|trans([],'BoAdminBundle')}}">*/
/* 					<img src="{{ asset('images/actions/next.gif') }}"/>*/
/* 				</a>*/
/* 			</li>*/
/* 			<li>*/
/* 				<a href="{{ path('message_page', {'option': nb_pages}) }}" title="{{'label.lastpage'|trans([],'BoAdminBundle')}}">*/
