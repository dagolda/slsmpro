...
/* BoAdminBundle:Activities:pagination.html.twig */
class __TwigTemplate_50130322b287015af746b543c4b80cb86d273684c8afe6348f977e4116171881 extends Twig_Template
{
    ...
    {
        $__internal_7493b9bdd96ca3c03960f323a821d09809bee8f4cc480ffa734c1c350479d117 = $this->env->getExtension("native_profiler");
        $__internal_7493b9bdd96ca3c03960f323a821d09809bee8f4cc480ffa734c1c350479d117->enter($__internal_7493b9bdd96ca3c03960f323a821d09809bee8f4cc480ffa734c1c350479d117_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "BoAdminBundle:Activities:pagination.html.twig"));
...
\t\t\t\t<a href=\"";
        // line 4
        echo $this->env->getExtension('routing')->getPath("activities_page", array("option" => 1));
        echo "\" title=\"";
...
\t\t\t\t<a href=\"";
        // line 9
        echo $this->env->getExtension('routing')->getPath("activities_page", array("option" => 2));
        echo "\" title=\"";
...
\t\t\t\t<a href=\"";
        // line 16
        echo $this->env->getExtension('routing')->getPath("activities_page", array("option" => 3));
        echo "\" title=\"";
...
\t\t\t\t<a href=\"";
        // line 21
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("activities_page", array("option" => (isset($context["nb_pages"]) ? $context["nb_pages"] : $this->getContext($context, "nb_pages")))), "html", null, true);
        echo "\" title=\"";
...
\t\t</ul>";
        ...
        $__internal_7493b9bdd96ca3c03960f323a821d09809bee8f4cc480ffa734c1c350479d117->leave($__internal_7493b9bdd96ca3c03960f323a821d09809bee8f4cc480ffa734c1c350479d117_prof);

    }

    public function getTemplateName()
    {
        return "BoAdminBundle:Activities:pagination.html.twig";
    }
...
/* 			<li class="sty-label">Page:</li>*/
/* 			<li class="page_first">*/
/* 				<a href="{{ path('activities_page', {'option': 1}) }}" title="{{'label.firstpage'|trans([],'BoAdminBundle')}}">*/
/* 					<img src="{{ asset('images/actions/first.gif') }}"/>*/
/* 				</a>*/
/* 			</li>*/
/* 			<li>*/
/* 				<a href="{{ path('activities_page', {'option': 2}) }}" title="{{'label.previouspage'|trans([],'BoAdminBundle')}}">*/
...
/* 			</li>*/
/* 			<li>*/
/* 				<a href="{{ path('activities_page', {'option': 3}) }}" title="{{'label.nextpage'|trans([],'BoAdminBundle')}}">*/
/* 					<img src="{{ asset('images/actions/next.gif') }}"/>*/
/* 				</a>*/
/* 			</li>*/
/* 			<li>*/
/* 				<a href="{{ path('activities_page', {'option': nb_pages}) }}" title="{{'label.lastpage'|trans([],'BoAdminBundle')}}">*/
